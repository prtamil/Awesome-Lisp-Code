...
(let ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 300 :width 300)))
  ...
  (draw scene (:rect :x 75 :y 75 :height 30 :width 30)
        :fill "purple")
  (with-open-file (s #p"test1.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 500 :width 500)))
  ...
  (with-open-file (s #p"test2.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 500 :width 500)))
  ...
  (dotimes (i 310)
    (draw scene (:ellipse :cx (random 500)
          ...
          :stroke "rgb(232, 229, 148)"
          :fill (one-of *groovy-test-colors*)))
  (with-open-file (s #p"test3.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
great colors.  And the random rectangles!  You want this as wallpaper.")
  (dotimes (i 1200)
    (draw scene (:rect :x (- (random 750) 25)
          ...
          :fill (one-of *groovy-test-colors*)))
  (with-open-file (s #p"test4.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700))
  ...
  (with-open-file (s #p"test5.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let*
  ...
  (draw scene (:rect :x 490 :y 490 :height 200 :width 200)
        :fill (xlink-href rg2))
  (with-open-file (s #p"test6.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :view-box "0 0 4000 2000"
  ...
  (with-open-file (s #p"test7.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700))
  ...
  (with-open-file (s #p"test8.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700)))
  ...
  (with-open-file (s #p"test9.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700))
  ...
  (with-open-file (s #p"test10.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700))
  ...
  (with-open-file (s #p"test11.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700
  ...
  (with-open-file (s #p"test12.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700
  ...
  (with-open-file (s #p"test13.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700
  ...
  (with-open-file (s #p"test14.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 300 :width 300)))
  ...
  (transform ((rotate 45 90 90) (translate -13))
    (draw scene (:rect :x 75 :y 75 :height 30 :width 30)
          :fill "purple"))
  (with-open-file (s #p"test15.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))
...
(let* ((scene (make-svg-toplevel 'svg-1.1-toplevel :height 700 :width 700
  ...
  (with-open-file (s #p"test16.svg" :direction :output :if-exists :supersede)
    (stream-out s scene)))

;;; Foreign objects
(with-svg-to-file (scene 'svg-1.1-toplevel :width 700 :height 700)
    (#p"test17.svg" :if-exists :supersede)
